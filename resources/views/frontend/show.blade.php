    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('products.show')}}}"><img src="{{asset('frontend/images/logo.png')}}" class="logo" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    <li class="nav-item"><a class="nav-link" href="{{route('products.show')}}">Home</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{asset('frontend/')}}gallery.html">Gallery</a></li>
...
<script src="{{asset('frontend/js/bootstrap-select.j')}}s"></script>
